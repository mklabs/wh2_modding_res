...
--# assume UTIL.registerForClick: function(component: CA_UIC, listener_name: string, callback:function())
--# assume UTIL.delete: function(uic: CA_UIC)
--# assume UTIL.registerComponent: function(name: string, component: COMPONENT_TYPE)
--# assume UTIL.unregisterComponent: function(name: string)
--# assume UTIL.createComponent: function(name: string, parentComponent: CA_UIC, componentFilePath: string, string ...) --> CA_UIC
--# assume UTIL.digForComponent: function(startingComponent: CA_UIC, componentName: string) --> CA_UIC
...
--# assume TEXT_BUTTON.SetStateText: method(text: string)
...
--# assume FRAME.AddCloseButton: method(callback: function, cross: boolean?, hideInstead: boolean?)
--# assume FRAME.GetContentPanel: method() --> CA_UIC
--# assume FRAME.uic: CA_UIC
--# assume FRAME.content: CA_UIC
...
--# assume IMAGE.Height: method() --> number 
--# assume IMAGE.Width: method() --> number 
--text
...
--# assume TEXT.MoveTo: method(x: number, y: number)
--# assume TEXT.Scale: method(factor: number)
...
--# assume CONTAINER.isContainer: function(container: CONTAINER) --> boolean
--# assume CONTAINER.Clear: method()
--# assume CONTAINER.Empty: method()
--# assume CONTAINER.SetVisible: method(visible: boolean)
--# assume CONTAINER.Visible: method() --> boolean
